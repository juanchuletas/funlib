...
namespace
{
    ...
    void benchmarkShape(std::size_t M, std::size_t K, std::size_t N, sycl::queue m_queue)
    {
        ...
        std::cout<<std::setw(5)<<M<<"x"<<std::setw(5)<<K<<"x"<<std::setw(5)<<N
                 ...
                 <<std::setw(18)<<calculateGflops(M, K, N, blocked_kernel_time)
                 <<std::setw(18)<<tiled_total_time
                 <<std::setw(18)<<tiled_kernel_time
...
int main()
{
    ...
    std::cout<<"    M x    K x    N"
             ...
             <<std::setw(18)<<"Blocked GFLOPS"
             <<std::setw(18)<<"Tiled total ms"
             <<std::setw(18)<<"Tiled kernel ms"
             <<std::setw(18)<<"Tiled GFLOPS"
             <<std::setw(16)<<"Tiled speedup"
             <<std::endl;
