...
void benchmarkShape(std::size_t M, std::size_t K, std::size_t N,
  ...
  std::cout << std::setw(5) << M << "x" << std::setw(5) << K << "x"
            << std::setw(5) << N << std::setw(18) << host_total_time
            << std::setw(18) << device_total_time << std::setw(18)
            << device_kernel_time << std::setw(16)
            << calculateGflops(M, K, N, device_kernel_time) << std::setw(18)
            << blocked_total_time << std::setw(18) << blocked_kernel_time
...
int main() {
  ...
  std::cout << "    M x    K x    N" << std::setw(18) << "Host tiled ms"
            << std::setw(18) << "Device tiled ms" << std::setw(18)
            << "Tiled kernel ms" << std::setw(16) << "Tiled GFLOPS"
            << std::setw(18) << "Blocked total ms" << std::setw(18)
            << "Blocked kernel ms" << std::setw(16) << "Blocked GFLOPS"
            << std::endl;
